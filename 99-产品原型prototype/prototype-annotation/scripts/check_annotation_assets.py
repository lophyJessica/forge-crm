#!/usr/bin/env python3
"""Check forge-crm deployable annotation assets (adapted from vitamin check_annotation_assets).
...
def main():
    ap = argparse.ArgumentParser(description='Validate forge-crm annotation deploy assets (not DOM mounting/hosting).')
